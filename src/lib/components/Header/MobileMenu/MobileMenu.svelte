...
<nav class="fixed inset-0 bg-yellow-600">
	<ul class="flex flex-col items-center">
		<MobileMenuItem label="Text1" to="#" />

		<MobileMenuItem label="Text2" to="#" />

		<MobileMenuItem label="Text3" to="#" />

		<MobileMenuItem label="Text4" to="#" />
